...
public class Test {
	public static void main(String argv[])
	{
		...
		y = scan.nextDouble();
		p1.setY(y);
		copia_p1 = new Punt2D(p1); //Utilitzem el constructor de copia
		System.out.println("Introduzca las coordenadas X e Y del segundo punto: ");
		x = scan.nextDouble();
		p2.setX(x);
		y = scan.nextDouble();
		p2.setY(y);
		System.out.println("El tercer punto sera el orígen de coordenadas ");

		double distanciaPunt12 = copia_p1.distanciaPunto(p2.getX(), p2.getY()); //Nova funcio passant 2 doubles
		double distanciaPunt13 = copia_p1.distanciaPunto(p3);
